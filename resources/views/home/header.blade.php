...
<head>
    ...
    <title>Trust Options Pro - Learn to Invest</title>
...
_smartsupp.key = '63cd4165a66d090b2e5b24dafdb35ff36ba7b3f1';
    ...
    <nav class="navbar navbar-dark">
        <div class="container">
            <a class="navbar-brand" href="/">
                <div class="brand-icon"><img src="assets1/img/android-chrome-36x36.png" alt=""></div>
                Trust Options Pro
            </a>
    ...
    <div class="sidebar offcanvas offcanvas-start" tabindex="-1" id="sidebar" data-bs-scroll="true"
        ...
        <div class="profile-section mb-0 d-flex">
            <div class="d-block align-items-center text-center gap-3">
                <div class="profile-image py-1"><img src="{{asset('assets1/img/logo.png')}}" alt=""></div>
            </div>
