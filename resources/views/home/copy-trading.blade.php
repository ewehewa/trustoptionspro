...
<div class="about-main py-5 bg-black">
    <div class="container">
        <h4 class="about-page-title">Copy Trading</h4>
        <div class="about-content-section">
            <p class="about-section-text">
              It?s all in the name! Copy trading allows you to directly copy the positions taken by another trader. You decide the amount you wish to invest and simply copy everything they do automatically in real-time ? when that trader makes a trade, your account will make that same trade as well. You do not need to have any input on the trades, and you get the identical returns on each trade as your chosen trader. But by copying another trader, you could potentially make money based on their skills. In fact, no advanced knowledge of the financial market is required to take part!<br><br>

              Copy Trading is both a product and a service. We cater to both the traders and investors looking to capitalize in the cryptocurrency trading. Being able to copy trades from several expert traders and also allow investors to follow one?s trades is a great service in and of itself.<br><br>
            ...
            <h5 class="about-section-title">WHO ARE THE EXPERTS</h5>
            <p class="about-section-text">
            ...
            <h5 class="about-section-title">HOW DOES THIS WORK</h5>
            <p class="about-section-text">
