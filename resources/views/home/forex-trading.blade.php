@include('home.header')
<div class="forex-trading-main py-5 bg-black">
    <div class="container">
        <h1 class="forex-trading-page-title">Forex Trading</h1>
        <div class="forex-trading-content-section section">
            <p class="forex-trading-section-text">
            ...
            <h5 class="forex-trading-section-title">What is Margin?</h5>
            <p class="forex-trading-section-text">
                ...
                lots (10,000 units), micro lots (1,000 units), and nano lots (100 units). The greater the lot, the
                bigger the margin amount. Margin allows you to trade with leverage, which, in turn, allows you to place
                trades larger than the amount of your trading capital. Leverage influences the margin amount too.
            </p>

            <h5 class="forex-trading-section-title">What is Leverage?</h5>
            <p class="forex-trading-section-text">
            ...
            <h5 class="forex-trading-section-title">When is the Forex Market Open?</h5>
            <p class="forex-trading-section-text">
