@include('home.header')
<div class="crypto-mining-main py-5 bg-black">
    <div class="container">
        <h1 class="crypto-mining-page-title">Crypto Mining</h1>
        <div class="crypto-mining-content-section section">
            <p class="crypto-mining-section-text">
            ...
            <h5 class="crypto-mining-section-title">How Is Bitcoin Kept Secure?</h5>
            <p class="crypto-mining-section-text">
            ...
            <h5 class="crypto-mining-section-title">What Are the Incentives for Miners?</h5>
            <p class="crypto-mining-section-text">
            ...
            <h5 class="crypto-mining-section-title">The Big Vision of Cryptocurrency</h5>
            <p class="crypto-mining-section-text">
                To keep the integrity (and values!) of all cryptocurrency ecosystems intact, miners keep the networks
                safe and their authority decentralized by keeping each other constantly in check. This allows both
